                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="trad-history mt-4">
                                                ...
                                                <?php
                                                            foreach ($list as $product) {
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a href="<?php echo base_url() . "/Cart/removeFromCart/" .$product->id; ?>">Remove From Cart</a></td>
                                                                </tr>
                                                                <?php
                                                            }
                                                            ?>
                                    ...
                                    <a href="<?php echo base_url();?>Cart/placeOrder" class="btn btn-primary mt-4 pr-4 pl-4">Place Order</a>
                                </div>
                                                            <?php
                                                        } else {
                                                            ?>
                                                            No cart
                                                            <a href="<?php echo base_url();?>/Cart/products">Back To Products</a>
                                                            <?php
                                                        }
                                                    ?>
